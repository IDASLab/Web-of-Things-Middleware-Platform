...
5. If the application works well and perfect, you should see some kind of result on terminal screen.
    ...
    ![The Promised Running Result](https://github.com/IDAS-Labratory/Web-of-Things-Middleware-Platform/blob/master/docs/img/running_app_status.png?raw=true "Running Result")
